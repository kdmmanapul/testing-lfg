...
(function () {
    ...
    window.IsMouseInInventory = function () {
      if (!PKD_MI.isInventoryOpened()) return false;
      return PKD_MI.isProcessEUITouch();
  };
...
//Plugin PKD_MapInventory builded by PKD PluginBuilder 2.1 - 09.07.2022