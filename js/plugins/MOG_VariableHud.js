...
Scene_Map.prototype.createVariableHuds = function() {
	this._variableHud = [];
	$gameSystem._variableHudData = []
	$gameSystem._variableHudShow = false;
	for (var i = 0; i < 1; i++) {
...
VariableHud.prototype.number = function() {
	return DataManager.getGlobalVar('credit') ? DataManager.getGlobalVar('credit') : 0
};
...
VariableHud.prototype.createSprites = function() {
	this._variable = DataManager.getGlobalVar('credit') || 0;
...
VariableHud.prototype.createNumber = function() {
	...
	this._number.bitmap.textColor = '#468ce5';
...
VariableHud.prototype.refreshHud = function() {
	if (this.type() === 0) {
		if (this.number() > this.maxValue()) {
			DataManager.setGlobalVar('credit', this.maxValue())
		};
	};
...
VariableHud.prototype.needRefreshHud = function () {
	if ($gameSystem._variableHudShow) {
		this.fadeTimer = 30;
		return true
	};
