...
Imported.PRG_MissionPopup = true;

function Sprite_MissionPopup() {
    this.initialize.apply(this, arguments);
}

var _alias_game_temp2_initialize = Game_Temp.prototype.initialize;
Game_Temp.prototype.initialize = function () {
    _alias_game_temp2_initialize.call(this);
    this._MissionPopup = [];
};

(function () {
    var params = PluginManager.parameters('PRG_MissionPopup');
    params.x_Axis = Number(params['X-Axis'] || 400);
    params.y_Axis = Number(params['Y-Axis'] || 200);
    params.duration = Number(params['Duration'] || 200);

    Sprite_MissionPopup.prototype = Object.create(Sprite_Base.prototype);
    Sprite_MissionPopup.prototype.constructor = Sprite_MissionPopup;

    Sprite_MissionPopup.prototype.initialize = function () {
    ...
    Sprite_MissionPopup.prototype.loadImg = function () {
        //this._layout_img = ImageManager.loadSystem("Treasure");
        this._icon_img = ImageManager.loadSystem("IconSet");
    }

    Sprite_MissionPopup.prototype.update = function () {
        Sprite_Base.prototype.update.call(this);
        if ($gameTemp._MissionPopup.length > 0 && this._popupTimer < 0) {
            this.visible = true;
            this._item = $gameTemp._MissionPopup[0]
            $gameTemp._MissionPopup.shift();
            this._desc = '';
            if (DataManager.isSkill(this._item)) {
                var level = this._item.id % 5;
                if (level == 0) level = 5;
                this._desc = `Enemy Count ${$gameVariables.value(323)} Left`;
                if (!this._desc) this._desc = '';
            } else if (this._item.message1) {
                this._desc = `Enemy Count ${$gameVariables.value(323)} Left`
            } else this._desc = `Enemy Count ${$gameVariables.value(323)} Left`
    ...
    Sprite_MissionPopup.prototype.create_layout = function () {
    ...
    Sprite_MissionPopup.prototype.create_icon = function () {
    ...
    Sprite_MissionPopup.prototype.create_text = function () {
    ...
    Sprite_MissionPopup.prototype.refresh = function () {
    ...
    Sprite_MissionPopup.prototype.refresh_layout = function () {
    ...
    Sprite_MissionPopup.prototype.rarityTextColor = function (rarity) {
        switch (rarity) {
            case 2:
                return '#66cc40'
            case 3:
    ...
    Sprite_MissionPopup.prototype.refresh_description = function () {
    ...
    Scene_Map.prototype.createAllWindows = function () {
        ...
        this.createMissionPopup();
    };

    Scene_Map.prototype.createMissionPopup = function () {
        this._MissionPopup = new Sprite_MissionPopup();
        this.addChild(this._MissionPopup);
    };
})();
