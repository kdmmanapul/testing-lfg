...
(function() {
  ...
  var _CURSORIMGS = {
    default: _PARAMS['Default Cursor'],
      ...
      Auto: _PARAMS['Auto Cursor'],
      Crosshair: _PARAMS['Crosshair Cursor'],
      Move: _PARAMS['Move Cursor'],
      text: _PARAMS['Text Cursor'],
      help: _PARAMS['Help Cursor']
  }
  ...
  TouchInput.update = function() {
    ...
    this.updateCursorDecay();
  };
    
    TouchInput.updateCursorDecay = function () {
        if (!this._cursorHidden) {
            if (Input._lastUsed == 'keyboard') return;
            else this.hideCursor();
        } else {
            if (Input._lastUsed == 'gamepad') return;
