...
/*:
 * @plugindesc Game screen recording system(β)
 * @author ru_shalm
 *
 * @help
 * 【Note】
 * ・This plugin works with RPG Maker MV version 1.6 or above
 * ・If you record for a long time, the game will stop working.
 *
 *
 * Add a function to record the game screen.
 * The recorded file is saved next to the save folder. (video folder)
 * In case of a browser, a file save dialog is displayed.
 *
 * ------------------------------------------------------------
 * ■ Plugin Command
 * ------------------------------------------------------------
...
(function (global) {
    ...
    Game_Interpreter.prototype.pluginCommand = function (command, args) {
        if (command === 'GameRecorder' || command === 'record') {
            switch (args[0]) {
                case 'start':
                case 'スタート':
                case '開始':
