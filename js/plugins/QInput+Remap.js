...
(function() {
  ...
  Window_InputRemap.prototype.makeCommandList = function() {
    ...
    this.addActionKeys();
    //this.addMoveKeys();
    this.addCommand('Initialize', 'default');
  };

  Window_InputRemap.prototype.addActionKeys = function() {
      this.addCommand('Key settings', 'spaceholder', false);
    var actionkeys = ['ok', 'escape', 'shift', 'control', 'tab', 'space', '1', '2', '3','4'];
