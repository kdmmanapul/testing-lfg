...
Game_CharacterBase.prototype.motionY = function() {
	return this._shakeData[2] ? this._shakeData[2] : this._floatData[1];
};
...
Sprite_Character.prototype.updateShakeEffect = function() {
    ...
    var amt = this._character._shakeData[3];
    this._character._shakeData[1] = 2 * Math.randomInt(amt) - amt;
    this._character._shakeData[2] = 2 * Math.randomInt(amt) - amt;
    if (this._character._shakeData[0] === 0) {
        this._character._shakeData[1] = 0
        this._character._shakeData[2] = 0
    };
};
