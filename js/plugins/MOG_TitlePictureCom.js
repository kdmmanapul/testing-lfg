...
　　var Moghunter = Moghunter || {}; 
  ...
  　Moghunter.parameters = PluginManager.parameters('MOG_TitlePictureCom');
	...
	Moghunter.title_x = Number(Moghunter.parameters['Title Sprite X-Axis '] || 480);
	Moghunter.title_y = Number(Moghunter.parameters['Title Sprite Y-Axis '] || 270);
