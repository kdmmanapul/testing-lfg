...
(function() {
  ...
  Game_CharacterBase.prototype.updateIdlePose = function(dir, diag) {
    ...
    this._pose = this._idlePose + dir;
      if (!$gameMap.isEventRunning() && !$gameSwitches.value(10)) this.updateIdleInterval();
  };
  ...
  Game_CharacterBase.prototype.updatePattern = function() {
    if (this._isIdle || this._posePlaying || this.qSprite()) {
        this._pattern++;
        if (this == $gamePlayer) {
            if (this._pose.substring(0, 7) === 'btkmove' || this._pose.substring(0, 7) === 'btkidle') {
                if (!TouchInput.isPressed() && !Input.isPressed('$L2') && !TouchInput.isPressed2() && !Input.isPressed('$R2'))
                    this.clearPose();
            }
        } else if (this._pose.substr(this._pose.length - 1, 1) != this._direction) this._pose = this._pose.slice(0, -1) + this._direction;
