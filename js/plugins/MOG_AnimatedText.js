...
InfoText.prototype.letterSpace = function() {
	if (this.pos() === 0) {
	    return Moghunter.infoText_LetterSpaceX + Math.floor(this.fontsz() / 1.5);
	} else {
...
InfoText.prototype.setPhase1 = function (sprite) {
    if (this.duration == 'inf') sprite.w2 = -1;
	else sprite.w2 = (sprite.itemMax * this.lagTime()) + this.duration();
	sprite.phase = 1;
};
